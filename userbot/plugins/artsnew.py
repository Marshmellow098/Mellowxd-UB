...
@mellow.on(admin_cmd(pattern=r"ded"))
...
@mellow.on(admin_cmd(pattern=r"monster"))
async def bluedevilmonster(monster):
    await monster.edit(M)
@mellow.on(admin_cmd(pattern=r"pig"))
async def bluedevilpig(pig):
    await pig.edit(P)
@mellow.on(admin_cmd(pattern=r"kiler"))
async def bluedevilkiller(kiler):
    await kiler.edit(K)
@mellow.on(admin_cmd(pattern=r"gun"))
async def bluedevilgun(gun):
    await gun.edit(G)
@mellow.on(admin_cmd(pattern=r"dog"))
async def bluedevildog(dog):
    await dog.edit(D)    
@mellow.on(admin_cmd(pattern=r"hello"))
async def bluedevilhello(hello):
    await hello.edit(H)
@mellow.on(admin_cmd(pattern=r"hmf"))
