...
@mellow.on(admin_cmd(pattern="pname ((.|\n)*)"))  # pylint:disable=E0602,W0703
async def _(event):
    if event.fwd_from:
        return
...
@mellow.on(admin_cmd(pattern="ppic"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
...
@mellow.on(admin_cmd(outgoing=True, pattern="username (.*)"))
...
@mellow.on(admin_cmd(outgoing=True, pattern="count$"))
...
@mellow.on(admin_cmd(outgoing=True, pattern=r"delpfp"))
...
@mellow.on(admin_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
