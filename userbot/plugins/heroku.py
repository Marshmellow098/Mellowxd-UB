...
@mellow.on(mellow_cmd(pattern="(set|get|del) var(?: |$)(.*)(?: |$)([\s\S]*)", outgoing=True))
...
@mellow.on(mellow_cmd(pattern="usage(?: |$)", outgoing=True))
...
@mellow.on(mellow_cmd(pattern="logs$", outgoing=True))
async def _(dyno):        
        try:
