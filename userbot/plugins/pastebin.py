...
@mellow.on(admin_cmd(pattern="paste ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@mellow.on(admin_cmd(outgoing=True, pattern="getpaste(?: |$)(.*)"))
...
@mellow.on(admin_cmd(pattern="neko ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    datetime.now()
...
@mellow.on(admin_cmd(pattern="iffuci ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@mellow.on(admin_cmd(pattern="paster ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    datetime.now()
