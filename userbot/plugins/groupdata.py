...
@mellow.on(admin_cmd(pattern="leave$"))
async def leave(e):
...
@mellow.on(admin_cmd(pattern="chinfo(?: |$)(.*)", outgoing=True))
...
@mellow.on(admin_cmd(pattern="adminlist", outgoing=True))
@errors_handler
...
@mellow.on(admin_cmd(pattern=r"users ?(.*)", outgoing=True))
