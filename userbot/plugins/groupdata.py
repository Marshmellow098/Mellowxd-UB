...
@mellow.on(mellow_cmd(pattern="leave$"))
async def leave(e):
...
@mellow.on(mellow_cmd(pattern="chinfo(?: |$)(.*)", outgoing=True))
...
@mellow.on(mellow_cmd(pattern="adminlist", outgoing=True))
@errors_handler
...
@mellow.on(mellow_cmd(pattern=r"users ?(.*)", outgoing=True))
