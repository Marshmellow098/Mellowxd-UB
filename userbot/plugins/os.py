...
@mellow.on(mellow_cmd(pattern=r"macos"))
...
@mellow.on(mellow_cmd(pattern=r"windows"))
...
@mellow.on(mellow_cmd(pattern=r"linux"))
...
@mellow.on(mellow_cmd(pattern=r"stock"))
...
@mellow.on(mellow_cmd(pattern=r"os"))
