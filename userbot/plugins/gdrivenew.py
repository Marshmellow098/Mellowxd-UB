...
@mellow.on(admin_cmd(pattern="gdrive ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@mellow.on(admin_cmd(pattern="dfolder https?://drive\.google\.com/drive/u/\d/folders/([-\w]{25,})", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@mellow.on(admin_cmd(pattern="gclear", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@mellow.on(admin_cmd(pattern="gdir ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@mellow.on(admin_cmd(pattern="drive (delete|get) ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@mellow.on(admin_cmd(pattern="sdrive ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
